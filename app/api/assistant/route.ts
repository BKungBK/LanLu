...
const responseSchema = {
  ...
  properties: {
    ...
    drafts: { type: Type.ARRAY, items: { type: Type.OBJECT, properties: { kind: { type: Type.STRING, enum: ["ingredient", "menu", "recipe"] }, rows: { type: Type.ARRAY, items: { type: Type.OBJECT, properties: { name: { type: Type.STRING }, unit: { type: Type.STRING }, supplier: { type: Type.STRING }, unitCost: { type: Type.NUMBER }, reorderPoint: { type: Type.NUMBER }, quantityOnHand: { type: Type.NUMBER }, expiresOn: { type: Type.STRING }, packageUnit: { type: Type.STRING }, packageCount: { type: Type.NUMBER }, contentQuantity: { type: Type.NUMBER }, contentUnit: { type: Type.STRING }, purchasePrice: { type: Type.NUMBER }, conversionFactor: { type: Type.NUMBER }, menuName: { type: Type.STRING }, ingredientName: { type: Type.STRING }, quantity: { type: Type.NUMBER }, category: { type: Type.STRING }, price: { type: Type.NUMBER }, active: { type: Type.BOOLEAN } } } }, warnings: { type: Type.ARRAY, items: { type: Type.STRING } } }, required: ["kind", "rows"] } },
