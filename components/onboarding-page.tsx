...
import { IconArrowRight, IconCheck, IconCoffee, IconHome } from "@tabler/icons-react";
...
export function OnboardingPage() {
  ...
  return <main className="onboarding-page"><div className="onboarding-head"><div className="onboarding-brand"><span className="brand-mark">LL</span><strong>LanLu</strong></div><div className="onboarding-progress" role="progressbar" aria-label="ความคืบหน้าการตั้งค่าร้าน" aria-valuemin={1} aria-valuemax={2} aria-valuenow={step}><span>ตั้งค่าร้าน</span><div className="progress-dots" aria-hidden="true"><i className={step >= 1 ? "active" : ""} /><i className={step >= 2 ? "active" : ""} /></div></div></div>
    ...
    </div><p className="onboarding-aside">LanLu จะใช้ข้อมูลของร้านคุณเพื่อคำนวณยอดขาย สต๊อก ต้นทุนโดยประมาณ และ forecast แบบอธิบายได้. ถ้าข้อมูลยังไม่พอ ระบบจะแสดงข้อจำกัดแทน insight ปลอม</p></main>;
}
