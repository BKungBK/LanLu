...
export function MenuSettings() {
  const { state, addMenuItem, updateMenuItem, createMenuCategory, saveRecipe, archiveCatalogItem, restoreCatalogItem, archiveRecipe, loading } = useLanlu();
  ...
  return <>
    <PageHeader eyebrow="Catalog" title="เมนูและสูตร" description="จัดการเมนูและสูตรแยกจากข้อมูลร้าน เพื่อคำนวณต้นทุนและการใช้วัตถุดิบ" action={<Link href="/inventory" className="button button-soft"><IconToolsKitchen2 size={15} />ไปวัตถุดิบ</Link>} />
